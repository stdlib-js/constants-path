...
```javascript
import constants from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-path@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { DELIMITER, DELIMITER_POSIX, DELIMITER_WIN32, SEP, SEP_POSIX, SEP_WIN32 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-path@v0.1.0-deno/mod.js';
```
